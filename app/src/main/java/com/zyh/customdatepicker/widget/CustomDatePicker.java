package com.zyh.customdatepicker.widget;
...
import com.zyh.customdatepicker.R;
...
public class CustomDatePicker {
    ...
    private void initParameter() {
        ...
        endYear = endCalendar.get(Calendar.YEAR)+10;
        endMonth = endCalendar.get(Calendar.MONTH) + 12;
        if (endMonth > 12) endMonth = 12;
        endDay = endCalendar.get(Calendar.DAY_OF_MONTH);
        if (endMonth == 12) endDay = 31;
        endHour = endCalendar.get(Calendar.HOUR_OF_DAY);
        if (endMonth == 12) endHour = 23;
